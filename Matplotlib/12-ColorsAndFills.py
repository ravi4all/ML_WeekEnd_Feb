...
def graph_data(stock):
    ...
    # to fill the color b/w x and y
    # if we are like investing or buying or investing
    # the profit color will be green and loss color will be red
