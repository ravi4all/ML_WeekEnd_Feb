...
def graph_data(stock):
    ...
    plt.ylabel('Price')
    # For volume
    # twinx - we are sharing same x-axis
    ax2v = ax2.twinx()
    ...
    ax2v.fill_between(date[-start:], 0, volume[-start:], facecolor='c', alpha=0.5)
    ...
    leg.get_frame().set_alpha(0.4)
    plt.show()
    fig.savefig('googleStock.png', facecolor=fig.get_facecolor())
